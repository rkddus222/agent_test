...
def lint_semantic_models(path: str):
    ...
    """
    try:
        from semantic.model_manager.linter.semantic_linter import lint_semantic_models as lint_func
...
def parse_semantic_models(path: str):
    ...
    try:
        ...
        from semantic.model_manager.parser.semantic_parser import assemble_manifest, write_manifest
...
def convert_smq_to_sql(smq_json: str, manifest_path: str = None, dialect: str = "bigquery"):
    ...
    try:
        ...
        from semantic.smq2sql_service import prepare_smq_to_sql
        ...
        if result.get("success"):
            ...
            if queries and len(queries) > 0:
                return {
                    ...
                    "metadata": queries[0].get("metadata", []),
                    "all_queries": queries
                }
            else:
